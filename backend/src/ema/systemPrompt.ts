...
- Financing (flex_pay): only present it if create_offer succeeds. If it returns financing_not_configured, do not promise financing — say checkout is standard for now and pivot to another authorized approach.
